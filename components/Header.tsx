                                    ...
                                    {adminOpen && (
                                        <div className="origin-top-right absolute left-0 mt-2 w-48 rounded-md shadow-lg var-bg ring-1 ring-border">
                                            <div className="py-1" role="menu" aria-orientation="vertical">
                                                ...
                                                <a href="#" onClick={(e) => { e.preventDefault(); onNavigate('customers'); setAdminOpen(false); }} className="block px-4 py-2 text-sm text-fg hover:bg-muted" role="menuitem">Customer Data</a>
