-- Diagnostic Script for Leads Pipeline
...
-- Show any existing constraints or indexes
DO $$
BEGIN
    ...
    LOOP
        RAISE NOTICE '   Constraint: % (%): %', constraint.conname, constraint.contype, constraint.definition;
    END LOOP;
    ...
    LOOP
        RAISE NOTICE '   Index: %: %', index.indexname, index.indexdef;
    END LOOP;
END $$;
